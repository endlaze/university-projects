...
public final class Checker implements Visitor {
  ...
  private void establishStdEnvironment () {
    ...
    public Object visitLoopWhileDoCommand(LoopWhileDoCommand ast, Object o) {
        ...
        if(! eType.equals(StdEnvironment.booleanType)){                // Si no es una expresi�n booleana reporta el error
            reporter.reportError("Boolean expression expected here", "", ast.E.position);
        }
        
        ast.C.visit(this, null);                                      // Si la expresi�n es booleana, se visita el comando
        return null;
    }
    ...
    public Object visitLoopDoWhileCommand(LoopDoWhileCommand ast, Object o) {
        ...
        if(! eType.equals(StdEnvironment.booleanType)){            // Si la expresi�n no es booleana, reporta el error
            reporter.reportError("Boolean expression expected here", "", ast.E.position);
        }
    ...
    public Object visitLoopForCommand(LoopForCommand ast, Object o) {
        ...
        if(! eType.equals(StdEnvironment.integerType)){             // Si la expresi�n no es entera, reporta el error
