...
>>>>>>> 104e3a9cea0c2dab05d34b2e908ed6540d603780
        public static void Register(HttpConfiguration config)
        {
            ...
            for(int i=1; i<=70; i++)
            {
                Logic.Load.ImageLoad.Load(i.ToString()); 
